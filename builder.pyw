...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}Bone_Skewer.ico")
        ...
        self.fileopts = customtkinter.CTkOptionMenu(self.builder_frame, values=["pyinstaller", ".py"],
                                                    ...
                                                    fg_color="#2b565e", button_hover_color="#366b76", button_color="#27464b", command=self.multi_commands)
